...
public class Card implements Serializable{
    ...
    public Color getColor(){
        switch (num){
            case 2:
                Color c1=new Color(100,220,210,200);
                return c1;

            case 4:
                Color c2=new Color(160,220,111,200);
                return c2;

            case 8:
                Color c3=new Color(225,225,111,200);
                return c3;

            case 16:
                Color c4=new Color(225,225,111,200);
                return c4;

            case 32:
                Color c5=new Color(225,225,111,200);
                return c5;

            case 64:
                return new Color(250,150,111,200);
            ...
            case 256:
                Color c8=new Color(200,90,70,200);
                return c8;

            case 512:
                Color c9=new Color(225,90,60,200);
                return c9;

            case 1024:
                Color c10=new Color(225,90,80,200);
                return c10;

            case 2048:
                Color c11=new Color(225,20,90,200);
                return c11;

            default:
                Color c0=new Color(225,225,225,160);
                return c0;
    ...
    public void draw(Graphics g) {
        ...
        if(num!=0){
            ...
            Font ff=new Font("黑体",Font.BOLD,25);
            g.setFont(ff);
