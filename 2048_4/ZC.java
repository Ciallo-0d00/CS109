...
public class ZC implements ActionListener {
    ...
    public ZC(ZCframe zCframe, DLPanel dlpanel, DLframe dLframe, ZCPanel zCPanel,GamePanel gamePanel) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(tx.equals("注册")){
            ...
            AccountManager accountManager = new AccountManager(zCframe,gamePanel);
